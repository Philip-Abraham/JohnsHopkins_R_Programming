...
#Now let's consider the case in which we don't know the length of the csv file and we just want to get
#the last city in the ranking.
...
## Considering cities.csv, in this case we want to know what's the second city by size of each country, 
## without knowing the dimension of our database and the number of countries. We want a data frame with
## these cities as final output.
